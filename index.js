...
var getPlatforms = function (projectName) {
  ...
  platforms.push({
    ...
    icons : [
      { name: 'Icon-24@2x.png',             size : 24   * 2   },
      { name: 'Icon-27.5@2x.png',           size : 27.5 * 2   },
      { name: 'Icon-29@2x.png',             size : 29   * 2   },
      { name: 'Icon-29@3x.png',             size : 29   * 3   },
      { name: 'icon-40@2x.png',             size : 40   * 2   },
      { name: 'Icon-44@2x.png',             size : 44   * 2   },
      { name: 'Icon-86@2x.png',             size : 86   * 2   },
      { name: 'Icon-98@2x.png',             size : 98   * 2   },
      { name: 'Icon-App-20x20@1x.png',      size : 20   * 1   },
      { name: 'Icon-App-20x20@2x-1.png',    size : 20   * 2   },
      { name: 'Icon-App-20x20@2x.png',      size : 20   * 2   },
      { name: 'Icon-App-20x20@3x.png',      size : 20   * 3   },
      { name: 'Icon-App-29x29@1x.png',      size : 29   * 1   },
      { name: 'Icon-App-29x29@2x-1.png',    size : 29   * 2   },
      { name: 'Icon-App-29x29@2x.png',      size : 29   * 2   },
      { name: 'Icon-App-29x29@3x.png',      size : 29   * 3   },
      { name: 'Icon-App-40x40@1x.png',      size : 40   * 1   },
      { name: 'Icon-App-40x40@2x-1.png',    size : 40   * 2   },
      { name: 'Icon-App-40x40@2x.png',      size : 40   * 2   },
      { name: 'Icon-App-40x40@3x.png',      size : 40   * 3   },
      { name: 'Icon-App-60x60@2x.png',      size : 60   * 2   },
      { name: 'Icon-App-60x60@3x.png',      size : 60   * 3   },
      { name: 'Icon-App-76x76@1x.png',      size : 76   * 1   },
      { name: 'Icon-App-76x76@2x.png',      size : 76   * 2   },
      { name: 'Icon-App-83.5x83.5@2x.png',  size : 83.5 * 2   },
      { name: 'ItunesArtwork@2x.png',       size : 1024 * 1   }
    ]
  });
  platforms.push({
    name : 'android',
